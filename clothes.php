...
<body>  
    ...
    <div class="menu-block">
        <ul>
            ...
            <a href="clothes.php" class="selected"><li><i class="fa-solid fa-shirt" style="color:darkcyan"></i> Clothes</li></a>
    ...
    <main>
        ...
        <section class="main-content">
            <div class="main-title">
                <h1>Clothes</h1>
                <p>Buy drip and SWAG with us</p>
            </div>
            <div class="card-container">
               <?php 
               $rows = $pdo->query("SELECT * FROM products WHERE category = 'Clothes'")->fetchAll(PDO::FETCH_ASSOC);
               $product = count($rows);
