...
<body>  
    ...
    <div class="menu-block">
        <ul>
            ...
            <a href="shoes.php" class="selected"><li><i class="fa-solid fa-shoe-prints" style="color:olive"></i> Shoes</li></a>
    ...
    <main>
        ...
        <section class="main-content">
            <div class="main-title">
                <h1>Shoes</h1>
                <p>Want some new kicks?</p>
            </div>
            <div class="card-container">
               <?php 
               $rows = $pdo->query("SELECT * FROM products WHERE category = 'shoes'")->fetchAll(PDO::FETCH_ASSOC);
               $product = count($rows);
