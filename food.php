...
<body>  
    ...
    <div class="menu-block">
        <ul>
            ...
            <a href="food.php"><li class="selected"><i class="fa-solid fa-burger" style="color:tan;"></i> Food & Beverage</li></a>
        </ul>
    </div>
    <main>
        ...
        <section class="main-content">
            ...
            <div class="card-container">
               <?php 
               $rows = $pdo->query("SELECT * FROM products WHERE category = 'Food & Beverage'")->fetchAll(PDO::FETCH_ASSOC);
               $product = count($rows);
